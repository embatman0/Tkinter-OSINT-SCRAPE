...
label3 = Label(win, text="Type in location coordinates & distance", font=("Helvetica", 20), bg= "white", fg="#d32b3e")
label3.pack(ipadx=1, ipady=1)
label4 = Label(win, text="Example: 53.47284293240784,-2.298712036681443,1km", font=("Helvetica", 14), bg= "white", fg="#d32b3e")
